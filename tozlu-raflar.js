...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Toplam ' + postTitle.length + ' Yayın<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Toplam ' + numDisplayed + ' Kategori \'';
      tocNote += postFilter + '\' of '+ postTitle.length + ' Tüm Yayınlar<br/></span>';
   }
...
function showToc() {
  ...
  else { alert("Yükleniyor lütfen bekleyin..."); }
}
